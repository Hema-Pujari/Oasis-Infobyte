...
function funcy() {
    ...
    alltask.length != 0 ? pushNote.innerHTML = html : pushNote.innerHTML = `You To-do List is empty📃`;
    ...
    cpTask != 0 ? compTask.innerHTML = comp : compTask.innerHTML = "<h3 style='color:blue'>No task Completed📃</h3>";
